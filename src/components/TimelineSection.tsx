              ...
              <div className="relative group">
                ...
                <div
                  className={`absolute -left-[31px] md:-left-[47px] top-4 w-5 h-5 rounded-full border-2 transition-all duration-300 ${
                    isExpanded
                      ? 'bg-emerald-400 border-white shadow-[0_0_20px_rgba(52,211,153,0.5)] scale-125'
                      : 'bg-zinc-900 border-emerald-500/60 group-hover:bg-emerald-400 group-hover:shadow-[0_0_15px_rgba(52,211,153,0.4)]'
                  }`}
                />
                ...
                <div
                  ...
                  className="p-6 md:p-8 rounded-3xl glass border border-white/10 hover:border-emerald-400/50 transition-all cursor-pointer shadow-xl hover:shadow-2xl"
                >
