    ...
    <section id="contact" className="py-24 px-6 md:px-12 max-w-[1280px] mx-auto relative z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <div className="space-y-3 font-mono text-xs">
              <a
                ...
                className="flex items-center gap-3 p-4 rounded-2xl bg-zinc-900/80 border border-white/10 hover:border-emerald-400 transition-all group"
              >
          ...
          {/* Scope Estimator */}
          <div className="p-8 rounded-3xl bg-zinc-900/90 border border-white/10 space-y-5 shadow-xl">
        ...
        <div className="p-8 rounded-3xl bg-zinc-900/90 backdrop-blur-xl border border-white/10 space-y-6 shadow-2xl">
          ...
          {submitted ? (
            <div className="p-8 rounded-2xl bg-emerald-500/10 border border-emerald-400 text-emerald-200 space-y-4 font-mono text-xs animate-fadeIn">
              ...
              <p className="font-sans leading-relaxed text-zinc-300">
                Thank you, {formData.name || 'Engineer'}. Your project inquiry has been queued. Tushar will review and respond shortly via email.
              </p>
              <button
                onClick={() => setSubmitted(false)}
                className="mt-2 px-6 py-2.5 rounded-full bg-emerald-400 text-black font-bold uppercase tracking-wider text-xs"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5 font-mono text-xs">
              ...
              <button
                type="submit"
                onMouseEnter={playHoverSound}
                className="w-full py-4 rounded-full bg-emerald-400 text-black font-bold uppercase text-xs tracking-widest hover:scale-105 transition-transform shadow-xl flex items-center justify-center gap-2"
              >
