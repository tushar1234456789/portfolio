    ...
    <footer className="bg-black border-t border-white/10 py-12 px-6 md:px-12 relative z-10 font-mono text-xs text-zinc-400">
      <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex items-center gap-3">
          ...
          <span className="text-zinc-500">© 2026. Engineered with Artistic Precision.</span>
        </div>
        ...
        <button
          onClick={scrollToTop}
          onMouseEnter={playHoverSound}
          className="px-5 py-2.5 rounded-full bg-zinc-900 hover:bg-emerald-400 hover:text-black text-emerald-400 border border-white/10 hover:border-emerald-400 transition-all flex items-center gap-1.5 uppercase tracking-widest text-[10px] font-bold"
        >
